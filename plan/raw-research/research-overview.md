...
This research phase also supports the larger goal of the assignment: using AI more tatically rather than relying on luck. Therefore, as a team, we now can understand a good output should look like and what software engineering practices we want to hold the project to. :contentReference[oaicite:12]{index=12}

## Team Research Contributions

- **Jonathan Hunter** — Slot Machine Visuals (`slot-machine-visuals`) — *pending / to be added*
